...
async function main() {
  ...
  const css = `*,*:before,*:after{box-sizing:border-box}body{margin:0;background:#05060a;color:#f8fbff;font-family:Inter,Barlow,sans-serif;-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}.bg{position:fixed;inset:0;z-index:-1;background:radial-gradient(circle at 50% 0%,rgba(55,224,255,.22),transparent 34%),radial-gradient(circle at 10% 10%,rgba(125,108,255,.16),transparent 32%),linear-gradient(180deg,#05060a,#08111c 55%,#030407)}.site-nav{position:sticky;top:0;z-index:10;display:flex;align-items:center;justify-content:space-between;padding:20px clamp(18px,5vw,72px);backdrop-filter:blur(22px);background:rgba(5,6,10,.72);border-bottom:1px solid rgba(255,255,255,.08)}.brand{display:flex;align-items:center;gap:10px;font-weight:700}.brand span{width:10px;height:10px;border-radius:99px;background:linear-gradient(135deg,#37e0ff,#7d6cff);box-shadow:0 0 22px #37e0ff}.site-nav nav{display:flex;gap:18px;color:#cbd5e1;font-size:14px}main{width:min(1180px,calc(100% - 32px));margin:0 auto;padding:54px 0 80px}.hero,.topic-hero{padding:54px 0 34px}.hero.compact{padding-top:34px}.eyebrow{margin:0 0 12px;color:#67e8f9;text-transform:uppercase;letter-spacing:2.4px;font-size:12px;font-weight:700}.hero h1,.topic-hero h1{font-family:"Instrument Serif",serif;font-style:italic;font-size:clamp(46px,8vw,92px);line-height:.92;margin:0;letter-spacing:0;font-weight:400}.hero p,.topic-hero p{max-width:760px;color:rgba(248,251,255,.74);font-size:clamp(16px,2vw,20px);line-height:1.6}.search-panel{margin:10px 0 40px;padding:16px;border:1px solid rgba(255,255,255,.12);border-radius:22px;background:rgba(255,255,255,.045);backdrop-filter:blur(26px)}.search-panel label{display:block;margin:0 0 10px;color:#91a4bd;font-size:13px}.search-panel input{width:100%;border:1px solid rgba(255,255,255,.15);border-radius:16px;background:rgba(0,0,0,.22);padding:16px 18px;color:#fff;font:inherit;outline:none}.search-panel input:focus{border-color:#37e0ff;box-shadow:0 0 0 3px rgba(55,224,255,.13)}.search-results{display:grid;gap:8px;margin-top:12px}.search-results a{display:flex;justify-content:space-between;gap:14px;padding:12px;border-radius:14px;background:rgba(255,255,255,.06);color:#eaf8ff}.section-head{display:flex;align-items:end;justify-content:space-between;gap:18px;margin:0 0 18px}.section-head h2{font-size:28px;margin:0}.section-head p{margin:0;color:#91a4bd}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.card{min-height:190px;padding:22px;border:1px solid rgba(255,255,255,.12);border-radius:22px;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.035));transition:transform .18s,border-color .18s,background .18s}.card:hover{transform:translateY(-3px);border-color:rgba(55,224,255,.45);background:rgba(55,224,255,.08)}.pill{display:inline-flex;margin-bottom:22px;padding:7px 10px;border-radius:999px;background:rgba(55,224,255,.1);color:#67e8f9;font-size:12px;font-weight:700}.card h2{font-size:23px;line-height:1.1;margin:0 0 10px}.card p{color:#b8c4d6;line-height:1.5;margin:0 0 18px}.meta{color:#e8fbff;font-size:13px}.stats{display:flex;flex-wrap:wrap;gap:10px;margin:22px 0}.stats span{padding:10px 13px;border-radius:999px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1);color:#dffbff}.start{display:inline-flex;padding:14px 20px;border-radius:16px;background:#37e0ff;color:#001014;font-weight:800}.questions{display:grid;gap:16px}.question{padding:22px;border:1px solid rgba(255,255,255,.12);border-radius:22px;background:rgba(255,255,255,.05)}.qtop{display:flex;justify-content:space-between;color:#67e8f9;font-size:12px;text-transform:uppercase;letter-spacing:1.5px}.qtop em{font-style:normal;color:#91a4bd}.question h2{font-size:21px;line-height:1.35;margin:12px 0 16px}.question ol{display:grid;gap:10px;margin:0 0 16px;padding-left:24px}.question li{padding:10px 12px;border-radius:12px;background:rgba(255,255,255,.045);color:#dbeafe}.question li.answer{border:1px solid rgba(52,211,153,.45);background:rgba(52,211,153,.12);color:#ecfdf5}details{border-top:1px solid rgba(255,255,255,.1);padding-top:12px;color:#cbd5e1}summary{cursor:pointer;color:#67e8f9;font-weight:700}.related{display:flex;flex-wrap:wrap;gap:10px}.related a{padding:11px 13px;border-radius:999px;background:rgba(255,255,255,.08);color:#dffbff}@media(max-width:820px){.grid{grid-template-columns:1fr}.site-nav{padding:16px}.site-nav nav{gap:12px}.hero,.topic-hero{padding-top:34px}.card{min-height:auto}.section-head{display:block}.question{padding:18px}}`;
